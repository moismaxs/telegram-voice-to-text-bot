...
- [ ] Обязательные подписки на каналы-спонсоры (монетизация без платежей от юзеров)
- [ ] Безлимит за Telegram Stars как альтернатива подпискам
- [ ] B2B-тариф для владельцев групп
- [ ] История расшифровок
